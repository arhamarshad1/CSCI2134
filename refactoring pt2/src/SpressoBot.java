 ...
 /**
  ...
  public int getNextMove() {
    ...
    if( energyLevel > 0 ) {
      ...
      for( int districtIndex = 0; districtIndex < scores.length; districtIndex++ ) {
        scores[districtIndex] = spressoSensed[districtIndex] * 4;
        boolean botWantsToMove = districtIndex != District.CURRENT;
        if( botWantsToMove && botsSensed[districtIndex] ) {
          scores[districtIndex] += 2;
          adj = 1;
        }
      }
