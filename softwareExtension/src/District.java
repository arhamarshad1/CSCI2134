...
public class District {
  ...
  protected TimBot resident;                       // ref to resident timbot
  protected int spressoJolts = 0;                  // # of jolts at harvest
  protected int spressoGrowth = 0;                 // # of rounds between harvests

  protected int mericanoCount = 0;
  protected int mericanoJolts = 0;
  protected int mericanoGrowth = 0;
  ...
  public District( DohNat planet, int x, int y, int jolts, int growth ) {
    ...
    // new addition
    mericanoJolts = jolts;
    mericanoGrowth = growth;
    mericanoCount = growth;
  ...
  private void moveTimBot(TimBot bot) {
